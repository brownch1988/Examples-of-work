...
class Ball
  ...
  def get_fortune
    ...
    case randomNo
      ...
      when 5
        $prediction = "unlikely"
      when 6
        $prediction = "Be less wishful"
      when 7
        $prediction = "Oh boy do I have a story for you"
      when 8
        $prediction = "Turn back now"
      when 9
        $prediction = "Hell awaits"
      when 10
  ...
  def say_greeting
    ...
    "\n\n\n\n\n\n\n\n\n\n\n\n\nPress Enter to " +
               "continue. \n\n: " +
               "Next you will be asked to enter your question. \n Enter your question to receive the answer."
    print greeting
  end
  ...
  def say_goodbye
    student = "Blaine Smith"
    school = "Bellevue University"
    schoolSite = "https://www.bellevue.edu/"
